...
def home(request):
    ...
    return render_to_response("tinyURL/index.html",
...
def stats(request, id):
    ...
    return render_to_response("tinyURL/stats.html", {"stats":stats, "link":link_db, "link_url":link_url},
                                        context_instance=RequestContext(request))
